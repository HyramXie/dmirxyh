...
def vllm_infer(
    model_name_or_path: str="/root/user/xyh/LLaMA-Factory-main/output/qwen2_5omni_lora_sft_mintrec2_sa",
    adapter_name_or_path: str = None,
    dataset: str = "MIntRec2_test_sa",
    dataset_dir: str = "data",
    template: str = "qwen2_omni",
    cutoff_len: int = 2048,
    max_samples: Optional[int] = None,
    vllm_config: str = "{}",
    save_name: str = "/root/user/xyh/LLaMA-Factory-main/eval/MIntRec2/generated_predictions_sa.json",
