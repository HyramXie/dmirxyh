...
def vllm_infer(
    model_name_or_path: str="output/qwen2_5omni_lora_sft_mintrec_text",
    adapter_name_or_path: str = None,
    dataset: str = "MIntRec_test_text",
    dataset_dir: str = "data",
    template: str = "qwen2_omni",
    cutoff_len: int = 2048,
    max_samples: Optional[int] = None,
    vllm_config: str = "{}",
    save_name: str = "eval/MIntRec/generated_predictions_text.json",
