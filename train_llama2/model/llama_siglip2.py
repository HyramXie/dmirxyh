...
class LLaMAWithSiglip(nn.Module):
    ...
    def forward(self, input_ids, attention_mask, pixel_values, labels=None):
        ...
        if self.use_fusion and fusion_output is not None:
