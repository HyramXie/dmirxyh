...
from model.moe_projector import MoEProjector
...
class QwenWithSiglip(nn.Module):
    def __init__(self, llm_path="Qwen/Qwen2.5-7B-Instruct", vision_path="google/siglip-so400m-patch14-384", device="cuda"):
        ...
        self.projector = MoEProjector(input_dim=vision_hidden_size, output_dim=llm_hidden_size, num_experts=4, top_k=2).to(device)
