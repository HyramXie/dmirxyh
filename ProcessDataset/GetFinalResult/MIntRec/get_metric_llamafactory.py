...
logger_file = "/root/user/xyh/ProcessDataset/GetFinalResult/MIntRec/result_report_vl.txt"
json_file = "/root/user/xyh/LLaMA-Factory-main/eval/MIntRec/generated_predictions_vl.json"
