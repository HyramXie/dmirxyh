...
# logger_file = "/root/user/xyh/ProcessDataset/GetFinalResult/MIntRec2/result_report_vl_moe.txt"
json_file = "/root/user/xyh/train_llama_imagebind/eval/mintrec2_predictions_fusion.json"
